...
const diagnoses: Diagnosis[] = [
  ...
  },
  {
    ...
    latin: 'Distorsio et/sive distentio articulationum et ligamentorum partium aliarum sive non specificatarum capitis'
  },
  {
    code: 'J10.1',
    name: 'Influenza with other respiratory manifestations, other influenza virus codeentified',
    latin: 'Influenza cum aliis manifestationibus respiratoriis ab agente virali aliis specificato'
  },
  {
    code: 'J06.9',
